...
fila = 1; columnas = 8;
exp4matriz_parametrosCNNVGG19CloudyBlur = zeros(fila,columnas);
capa = 4;
...
exp4matriz_parametrosCNNVGG19CloudyBlur(fila,:) = [capa,canal,e_m_dConvTC,e_v_dConvTC,t_m_dConvTC,t_v_dConvTC,t_est_m_dConvTC,t_est_v_dConvTC];
save(sprintf('%sExp4MatrizResultadosCNNVGG19_dConvC.mat',directorio_blur_Cloudy),'exp4matriz_parametrosCNNVGG19CloudyBlur');


% Obtención de los resultados mínimos en el mejor canal de la capa 'conv4_1'
canal_Conv1TC = exp4matriz_parametrosCNNVGG19CloudyBlur(1,2);
e_m_Conv1TC = exp4matriz_parametrosCNNVGG19CloudyBlur(1,3);
e_v_Conv1TC = exp4matriz_parametrosCNNVGG19CloudyBlur(1,4);
t_m_Conv1TC = exp4matriz_parametrosCNNVGG19CloudyBlur(1,5);
t_v_Conv1TC = exp4matriz_parametrosCNNVGG19CloudyBlur(1,6);
t_est_m_Conv1TC = exp4matriz_parametrosCNNVGG19CloudyBlur(1,7);
t_est_v_Conv1TC = exp4matriz_parametrosCNNVGG19CloudyBlur(1,8);
