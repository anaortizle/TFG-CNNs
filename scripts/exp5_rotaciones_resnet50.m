...
fila = 1; columnas = 8;
exp5matriz_parametrosCNNresnet50CloudyRotaciones = zeros(fila,columnas);
capa = 3;
...
exp5matriz_parametrosCNNresnet50CloudyRotaciones(fila,:) = [capa,canal,e_m_dConvTC,e_v_dConvTC,t_m_dConvTC,t_v_dConvTC,t_est_m_dConvTC,t_est_v_dConvTC];
save(sprintf('%sExp5MatrizResultadosCNNresnet50_dConvC_Rotaciones.mat',directorio_rotaciones_Cloudy),'exp5matriz_parametrosCNNresnet50CloudyRotaciones');


% Obtención de los resultados mínimos en el mejor canal de la capa 'conv4_1'
canal_Conv1TC = exp5matriz_parametrosCNNresnet50CloudyRotaciones(1,2);
e_m_Conv1TC = exp5matriz_parametrosCNNresnet50CloudyRotaciones(1,3);
e_v_Conv1TC = exp5matriz_parametrosCNNresnet50CloudyRotaciones(1,4);
t_m_Conv1TC = exp5matriz_parametrosCNNresnet50CloudyRotaciones(1,5);
t_v_Conv1TC = exp5matriz_parametrosCNNresnet50CloudyRotaciones(1,6);
t_est_m_Conv1TC = exp5matriz_parametrosCNNresnet50CloudyRotaciones(1,7);
t_est_v_Conv1TC = exp5matriz_parametrosCNNresnet50CloudyRotaciones(1,8);
